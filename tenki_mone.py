...
access_token = 'TXZLEuvQtvmvttuPI3tn6PSpyod9Tn9aKkeZisliCKK'
headers = {'Authorization': 'Bearer ' + access_token}

#天気サイトから欲しい情報を取得する
url2 = "https://tenki.jp/forecast/3/16/4410/13113/"   #欲しい情報があるURLを指定
res = requests.get(url2)                              #上記URL情報を取得する
soup = BeautifulSoup(res.content, 'html.parser')      #取得した情報をhtmlで解析する

# 以下各種情報を取得
target ="気"
sibuya_all=soup.find("h2").text
idx=sibuya_all.find(target)
sibuya=sibuya_all[:idx+1]
